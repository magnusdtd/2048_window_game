...
void drawTable(int mode, float half_size_of_each_cell, float distance_of_each_cell, u32* cell_color, const u32 number_of_cell_color, u32 background_color, int** scores, u32 number_color);